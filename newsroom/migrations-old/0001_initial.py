...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='article',
            name='author_01',
            field=models.ForeignKey(related_name='author_01', blank=True, to='newsroom.Author', verbose_name='first author', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='article',
            name='author_02',
            field=models.ForeignKey(related_name='author_02', blank=True, to='newsroom.Author', verbose_name='second author', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='article',
            name='author_03',
            field=models.ForeignKey(related_name='author_03', blank=True, to='newsroom.Author', verbose_name='third author', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='article',
            name='author_04',
            field=models.ForeignKey(related_name='author_04', blank=True, to='newsroom.Author', verbose_name='fourth author', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='article',
            name='author_05',
            field=models.ForeignKey(related_name='author_05', blank=True, to='newsroom.Author', verbose_name='fifth author', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(default=4, to='newsroom.Category', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='article',
            name='main_topic',
            field=models.ForeignKey(related_name='main', blank=True, help_text="Used for generating'See also' list of articles.", to='newsroom.Topic', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='article',
            name='region',
            field=models.ForeignKey(blank=True, to='newsroom.Region', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='article',
            name='topics',
